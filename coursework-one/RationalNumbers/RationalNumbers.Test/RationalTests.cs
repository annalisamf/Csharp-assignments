...
namespace RationalNumbers.Test
{
    ...
    public class RationalTests
    {
        ...
        public void Raise_a_real_number_to_a_positive_rational_number()
        {
            ...
            Assert.AreEqual(16, new RationalNumber(4, 3).ExpReal(8), 0.0000001);
        }
        ...
        public void Raise_a_real_number_to_a_negative_rational_number()
        {
            ...
            Assert.AreEqual(0.33333334, new RationalNumber(-1, 2).ExpReal(9), 0.0000001);
        }
        ...
        public void Raise_a_real_number_to_a_zero_rational_number()
        {
            ...
            Assert.AreEqual(1, new RationalNumber(0, 1).ExpReal(2), 0.0000001);
        }

        [TestMethod]
        public void Raise_a_real_number_to_a_negative_rational_number_string()
        {
            Assert.AreEqual(0.33333334, 9.ExpReal(new RationalNumber("-1/2")), 0.0000001);
            Assert.AreEqual(0.33333334, new RationalNumber("-1/2").ExpReal(9), 0.0000001);
        }
        ...
        [TestMethod]
        public void Create_string_fraction()
        {
            Assert.AreEqual(new RationalNumber("10 / 5 "), new RationalNumber(2).Reduce());
        }

        [TestMethod]
        public void Add_one_positive_one_negative_rational_string()
        {
            Assert.AreEqual(new RationalNumber(-1, 6), new RationalNumber("1/2") + new RationalNumber(-2, 3));
        }

        [TestMethod]
        public void Raise_a_positive_rational_number_string_to_a_positive_integer_power()
        {
            Assert.AreEqual(new RationalNumber("1/8"), new RationalNumber(1, 2).ExpRational(3));
        }

        [TestMethod]
        public void Subtract_two_positive_rational_numbers_string()
        {
            Assert.AreEqual(new RationalNumber(-1, 6), new RationalNumber("1/2") - new RationalNumber("2/3"));
        }

        [TestMethod]
        public void Transform_a_positive_fraction_to_decimal()
        {
            Assert.AreEqual(0.5, new RationalNumber(1, 2).ToDecimal());
        }

        [TestMethod]
        public void Transform_a_negative_fraction_to_decimal()
        {
            Assert.AreEqual(-0.6, new RationalNumber(6, -10).ToDecimal());
        }

        [TestMethod]
        public void create_GDC_of_two_positive_numbers()
        {
            Assert.AreEqual(3, RationalNumber.Gcd(3, 9));
        }

        [TestMethod]
        public void create_GDC_of_two_negative_numbers()
        {
            Assert.AreEqual(2, RationalNumber.Gcd(-10, -22));
        }
    }
}